...
makevn_load_config() {
  ...
  unset MAKEVN_CRAP4JAVA_JAR MAKEVN_CRAP_THRESHOLD MAKEVN_CRAP_MAX_WARNINGS
  unset MAKEVN_COMPOSE_FILE MAKEVN_E2E_COMPOSE_FILE MAKEVN_LOCAL_CONTAINERS MAKEVN_APP_HEALTH_URL
  unset MAKEVN_CLEAN_GENERATED_CONTRACT_TARGETS MAKEVN_GENERATED_CONTRACT_CLEAN_DIRS
