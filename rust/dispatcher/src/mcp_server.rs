...
const TOOL_SPECS: &[ToolSpec] = &[
    ...
    ToolSpec { name: "test", description: "Run tests with optional name filter and fast mode.", command: &["test"], options: &[COMMON_REPO, ToolOption { name: "name", ty: "string", description: "Test class name or comma-separated names", required: false }, ToolOption { name: "fast", ty: "boolean", description: "Skip compilation when sources have not changed", required: false }, COMPACT] },
